...
function ProjectGallery({ modalContent, classes }: ProjectGalleryProps) {
    ...
    const handlePrev = () => {
        setCurrentImageIndex((currentImageIndex-1) % modalContent.imageGallery.length);
    }
    ...
    return (
        <div className={`rounded-t-3xl h-full ${classes}`} style={{backgroundImage:`url(${modalContent.imageGallery[currentImageIndex]})`, backgroundSize:'100% 100%'}}>
